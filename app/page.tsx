        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 w-full max-w-8xl">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-600 leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
                Manage accounting, budgets, and financial reporting with advanced analytics and real-time insights.
              </p>
            </div>
          </Link>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-600 leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
                Streamline recruitment, payroll, performance management, and employee development processes.
              </p>
            </div>
          </Link>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-600 leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
                Boost revenue with CRM tools, pipeline management, and comprehensive sales analytics.
              </p>
            </div>
          </Link>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-600 leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
                Track stock levels, automate reordering, and optimize warehouse operations efficiently.
              </p>
            </div>
          </Link>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-600 leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
                Ensure optimal asset performance with preventive maintenance scheduling and tracking.
              </p>
            </div>
          </Link>
        </div>
